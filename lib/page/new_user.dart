...
class _new_userState extends State<new_user> {
  ...
  Future<void> setData() async {
    ...
    setState(() {
      shrtname = preferences.getString('shrtname').toString();
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text('Router Configured By (If Other)',
                              style: TextStyle(
                                color: Colors.black,
                                fontSize: 18,
                              )),
  ...
  Future<void> add() async {
    var res = await http
        .post(Uri.parse("https://androidtest.joogadnet.com/JoogadOperatorAppApi1/putData.php"),
        body: ({
          'action' : 'saveUser',
            "utype": dropdownvalue,
